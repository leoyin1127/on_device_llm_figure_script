...
# Save the figure
fig.write_image("chart2radar/output/eurorad_radar_plot_a.png", scale=3, engine="kaleido")

# Also save as interactive HTML
fig.write_html("chart2radar/output/eurorad_radar_plot_a.html")
...
print("\nRadar plot saved to: chart2radar/output/eurorad_radar_plot_a.png")
print("Interactive version saved to: chart2radar/output/eurorad_radar_plot_a.html")
