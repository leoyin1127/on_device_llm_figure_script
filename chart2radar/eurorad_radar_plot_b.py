...
# Plot (b): OSS-120B all configurations + gpt-5 reference
model_groups = {
    'gpt-5': [],
    'gpt-oss-120B (L)': [],
    'gpt-oss-120B (M)': [],
...
for col in model_cols:
    ...
    elif 'oss-120b (l)' in col.lower():
        model_groups['gpt-oss-120B (L)'].append(col)
    elif 'oss-120b (m)' in col.lower():
...
# Save the figure
fig.write_image("chart2radar/output/eurorad_radar_plot_b.png", scale=3, engine="kaleido")

# Also save as interactive HTML
fig.write_html("chart2radar/output/eurorad_radar_plot_b.html")

# Print summary statistics
print("\n=== Model Performance Summary (Plot B) ===")
print("Models included: OSS-120B all configurations + gpt-5 reference")
...
print("\nRadar plot saved to: chart2radar/output/eurorad_radar_plot_b.png")
print("Interactive version saved to: chart2radar/output/eurorad_radar_plot_b.html")
